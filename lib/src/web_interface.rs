...
// Workshop functionality has been moved to direct client usage
// These methods have been removed as they were just convenience wrappers
// around client functionality that can be accessed directly
